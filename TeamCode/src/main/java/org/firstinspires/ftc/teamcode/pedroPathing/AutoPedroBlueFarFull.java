...
@Autonomous(name = "PedroPathing Auto Blue Far Full", group = "Examples")
public class AutoPedroBlueFarFull extends AutoPedroCommon {
    ...
    public void setPath(){
        ...
        pathList.add(new PathItem(blue_2nd_row_end,blue_far_score,"shoot","shoot_2nd_row"));
