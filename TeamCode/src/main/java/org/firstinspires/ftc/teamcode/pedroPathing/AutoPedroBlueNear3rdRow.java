...
@Autonomous(name = "PedroPathing Auto Blue Near 3rd row", group = "Examples")
public class AutoPedroBlueNear3rdRow extends AutoPedroCommon {
    ...
    private final Pose blue_near_turn_left = new Pose(57, 10, Math.toRadians(180));
    private final Pose blue_near_corner = new Pose(22, 10, Math.toRadians(180));
     ...
     */
    public void setPath(){
        pathList.add(new PathItem(blue_near_init,blue_near_score,"shoot","shoot_preload"));
        pathList.add(new PathItem(blue_near_score,blue_3rd_row_start,"intake","intake_3rd_row"));
        pathList.add(new PathItem(blue_3rd_row_start,blue_3rd_row_end,"none","intake_3rd_row"));
        pathList.add(new PathItem(blue_3rd_row_end,blue_near_score,"shoot","intake_3rd_row"));
