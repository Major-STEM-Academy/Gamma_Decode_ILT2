...
//ignore this for now
@Disabled
@Autonomous(name="Red_Far_3_Leave_Base")
public class Red_Far_3_Leave_Base extends AutoHardware  {

    // Motor encoder parameter
    double ticksPerInch = 31.3;
    double ticksPerDegree = 15.6;
    double hogback_rpm_far = 3860;  // Rotations Per Minute

    public Red_Far_3_Leave_Base() {
    }
